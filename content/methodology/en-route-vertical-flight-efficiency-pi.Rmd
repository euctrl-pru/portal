...
knitr::include_graphics("/images/vfe-er-figure-001.png")
```
...
knitr::include_graphics("/images/vfe-er-figure-002.png")
```
...
knitr::include_graphics("/images/vfe-er-figure-003.png")
```
...
[rad]: `r htmltools::HTML('{{< relref "/acronym/rad.md" >}}')` "RAD"
[prisme]: `r htmltools::HTML('{{< relref "/acronym/prisme.md" >}}')` "PRISME"
[gcd]: `r htmltools::HTML('{{< relref "/acronym/gcd.md" >}}')` "GCD"
[ftfm]: `r htmltools::HTML('{{< relref "/acronym/ftfm.md" >}}')` "FTFM"
