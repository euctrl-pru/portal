...
Based on this definition of taxi-out time (from off-block time to take-off time),
taxi-out time includes:
...
1. *Identification of the unimpeded flights*
     ...
     * Selection of flights with a
       ...
       $$
       \text{congestion index} <= 0.5 * \text{saturation level}
       $$
...
```{r check1, out.width=c('300px', '300px'), fig.cap ='(ref:check1)'}
...
* For unimpeded flights,
  * the median of the [additional taxi-out times][atxot]
    distribution should remain within the interval
    $\mathopen] -1\ \text{minute}, +1\ \text{minute} \mathclose[$,
...
[atxot]: /definition/additional-taxi-out-time/ "Additional Taxi-out Time definition"
