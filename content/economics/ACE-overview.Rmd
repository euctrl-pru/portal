...
In addition to high-level information on the Pan-European system revenues, costs and staff data, this report presents ANSPs ranking on several performance indicators including costs-effectiveness and ATCO-hour productivity. Specific financial indicators are also used to monitor potential cash and liquidity issues experienced by ANSPs because of the COVID-19 pandemic. Finally, the report provides an examination of ANSPs capital expenditures in 2020 and 2021 and how these changed compared to their pre-crisis levels. You can access the report [here](https://deploy-preview-5--ace-hlsr.netlify.app/){target="_blank"}.
