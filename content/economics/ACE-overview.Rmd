...
<div class="row align-items-start">
<div class="col-sm-2">
  <img src="/images/eco/ace2020.png" alt="ACE 2020 Report" style="border: 1px solid rgba(0,0,0,.125)">
...
[**Executive summary**](){target="_blank"}
</div>

<div style="background-color: #F2F2F2; "  >
[<i class="fas fa-download"></i>](){target="_blank"}
[**Main report**](){target="_blank"}
</div>

  1. [Introduction](){target="_blank"}

<details open>
<summary>**PART I:** Pan-European system cost-effectiveness performance in 2020</summary>
  2. [Pan-European cost-effectiveness performance in 2020](){target="_blank"}
  3. [Trend analysis and COVID-19 impacts on cost-effectiveness](){target="_blank"}
</details>
  4. [Impact of the COVID-19 pandemic on ANSPs financial situation](){target="_blank"}
</details>
  5. [Forward-looking cost-effectiveness (2021-2024)](){target="_blank"}
</details>

<details open>
  <summary>**PART II:** Cost-effectiveness performance focus at ANSP level</summary>
  5. [Summary of ANSPs individual cost-effectiveness performance](){target="_blank"}
  6. [Focus on ANSPs individual cost-effectiveness performance](){target="_blank"}
</details>

<details>
<summary>**Annexes**</summary>
  * [ANNEX 1 – Status of ANSPs 2020 Annual Reports](){target="_blank"}
  * [ANNEX 2 – Performance indicators used for the comparison of ANSPs](){target="_blank"}
  * [ANNEX 3 – Performance ratios](){target="_blank"}
  * [ANNEX 4 – Exchange rates, inflation rates and purchasing power parities (PPPS)](){target="_blank"}
  * [ANNEX 5 – Key data](){target="_blank"}
  * [ANNEX 6 – Performance indicators at FAB level](){target="_blank"}
...
<a href="https://www.eurocontrol.int/ACE/ACE-Factsheets.html" target="_blank">**Factsheets (Part II of the ACE Report)**</a>
</div>
