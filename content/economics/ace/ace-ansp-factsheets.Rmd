...
<div id="MyEmbed_div"><embed src="/library/ace/ansp-factsheets/Albcontrol.pdf" type="application/pdf" width="100%" height="850pt"></div>
</div><!-- closes col -->
</div><!-- closes row -->
