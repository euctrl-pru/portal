...
<div class="col-lg-6 ">
<div class="row">
<div class="col-6 float-left" id="ANSP_filter_div"></div>
<div class="col-6 mb-1">
<a id="mydownload" href="/library/ace/ansp-factsheets/Albcontrol.pdf" role="button" target="_blank"
class="float-right pr-1 pl-1" style="padding-top:2px; padding-bottom:2px; border-radius:2px; border:1px solid #aaaaaa; background: linear-gradient(to bottom, #fcfcfc, #dddddd)" type="button" download>Download .pdf
</a>
</div>
</div><!-- closes row -->
...
//					cssClass: 'ClassANSPPicker',
	...
	function changeANSP_Picker () {
	  ...
	  element1.src = 'https://drive.google.com/viewerng/viewer?embedded=true&url=https://www.eurocontrol.int/ACE/ANSP-Factsheets/'+SelectedANSP+'.pdf' ;		
		
		var element2 = document.getElementById("mydownload");
		var myurl = '/library/ace/ansp-factsheets/'+SelectedANSP+'.pdf';
