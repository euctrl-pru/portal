...
<div id="MyEmbed_div">
<iframe src="https://drive.google.com/viewerng/viewer?embedded=true&url=https://www.eurocontrol.int/ACE/ANSP-Factsheets/Albcontrol.pdf" width="100%" height="850pt">
</iframe>
</div>
</div><!-- closes col -->
</div><!-- closes row -->
...
//					cssClass: 'ClassANSPPicker',
	...
	function changeANSP_Picker () {
		...
		document.getElementById("MyEmbed_div").innerHTML = '<iframe src="https://drive.google.com/viewerng/viewer?embedded=true&url=https://www.eurocontrol.int/ACE/ANSP-Factsheets/'+SelectedANSP+'.pdf" width="100%" height="850pt" /></iframe>';
	}
</script>
