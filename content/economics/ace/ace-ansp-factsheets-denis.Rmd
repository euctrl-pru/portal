...
<div id="MyEmbed_div">
<embed src="https://www.eurocontrol.int/ACE/ANSP-Factsheets/Albcontrol.pdf" type="application/pdf" width="100%" height="850pt">
</div>
</div><!-- closes col -->
</div><!-- closes row -->
...
//					cssClass: 'ClassANSPPicker',
	...
	function changeANSP_Picker () {
		...
		document.getElementById("MyEmbed_div").innerHTML = '<embed src="https://www.eurocontrol.int/ACE/ANSP-Factsheets/'+SelectedANSP+'.pdf" type="application/pdf" width="100%" height="850pt" />';
	}
</script>
