...
The [additional taxi-out time](`r htmltools::HTML("{{< relref \"/definition/additional-taxi-out-time.md\" >}}")`)
...
[unimpeded taxi-out time](`r htmltools::HTML("{{< relref \"/definition/unimpeded-taxi-out-time.md\" >}}")`)
