...
[Additional Arrival Sequencing and Metering (ASMA) time](/definition/additional-asma-time/)
...
| TOTAL_REF_TIME_MIN | Airport         | TOTAL_REF_TIME_MIN        | Total reference ASMA time in minutes                            | 48,260.40        |
| TOTAL_ADD_TIME_MIN | Airport         | TOTAL_ADD_TIME_MIN        | Total additional ASMA time in minutes                           | 1,718.60         |
...
|                    |                 | Avg. Reference ASMA Time  | \= ROUND( TOTAL_REF_TIME_MIN / TOTAL_REF_NB_FL ; 2 )            |                  |
|                    |                 | Avg. Additional ASMA Time | \= ROUND( TOTAL_ADD_TIME_MIN / TOTAL_REF_NB_FL ; 2 )            |                  |
