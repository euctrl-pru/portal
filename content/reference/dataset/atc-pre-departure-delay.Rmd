...
The
[ATC pre-departure delay](`r htmltools::HTML("{{< relref \"/definition/atc-pre-departure-delay.html\" >}}")`)
is a proxy for ATC induced delays at the departure stand to avoid queuing at the
departure runway.

The data is based on
[IATA delay code 89](`r htmltools::HTML("{{< relref \"/definition/iata-code-89.html\" >}}")`)
