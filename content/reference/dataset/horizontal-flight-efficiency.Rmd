...
[Great Circle Distance](`r htmltools::HTML("{{< relref \"/acronym/gcd.md\" >}}")`)
...
position reports or [CPR](`r htmltools::HTML("{{< relref \"/acronym/cpr.md\" >}}")`)) submitted by ANSPs
to the EUROCONTROL Enhanced Tactical Flow Management System
([ETFMS](`r htmltools::HTML("{{< relref \"/acronym/etfms.md\" >}}")`)).

**[KEP](`r htmltools::HTML("{{< relref \"/acronym/kep.md\" >}}")`)** and
**[KEA](`r htmltools::HTML("{{< relref \"/acronym/kea.md\" >}}")`)** are performance indicators measuring
...
[Horizontal en-route flight efficiency methodology](`r htmltools::HTML("{{< relref \"/methodology/horizontal-flight-efficiency-pi\" >}}")`)
...
(*) The  [HFE CSV files](`r htmltools::HTML("{{< relref \"/csv.md\" >}}")`)
use [ISO 8601][iso8601] date time format, i.e. `2017-01-02T00:00:00Z`
