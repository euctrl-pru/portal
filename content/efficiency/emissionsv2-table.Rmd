...
co2_data_plot_state <- co2_data_raw %>%
  ...
  mutate(STATE_NAME =gsub("Norway\\*", 'Norway<span><a href="#" data-toggle="tooltip" data-placement="right" title="Includes Jan Mayen and Slavbard">*</a></span>', STATE_NAME, ignore.case = TRUE))%>%
...
<img src="../CO2growth_MaytoMay2022vs19.png" alt="CO2 growth month to month vs 2019">
</div><!-- closes col -->
...
<div class="col-lg-9 pl-0 mt-1" >
<img src="../CO2growth_JantoMay2022vs2019.png" alt="CO2 growth month to month vs 2019">
</div><!-- closes col -->
