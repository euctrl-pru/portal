...
<div class="col-lg-9 pl-0 mt-1" id="observablehq-chart-7039140a">
</div><!-- closes col -->
...
new Runtime().module(define, name => {
  if (name === "chart") return new Inspector(document.querySelector("#observablehq-chart-7039140a"));
});
</script>