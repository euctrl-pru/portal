...
<div class="col-lg-9 pl-0 mt-1" id="observablehq-co2map-120d2f14">
</div><!-- closes col -->
...
import define from "https://api.observablehq.com/@espinielli/co2-emissions-variation-per-state@2403.js?v=3";
new Runtime().module(define, name => {
  if (name === "co2map") return new Inspector(document.querySelector("#observablehq-co2map-120d2f14"));
});
</script>
