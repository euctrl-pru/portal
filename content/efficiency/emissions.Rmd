...
base_dir <- '//sky.corp.eurocontrol.int/DFSRoot/Groups/HQ/dgof-pru/Project/Staff folders/Oscar/Portal/Developments/CO2/'
...
<br><br>
<div class="row align-items-start">
<div class="col-md-12" style="border: solid 1px #D9D9D9; border-radius: 4px;">
...
<div class="col-md-8">
##### Option 1 - 2nd indicator: CO2 emissions/departure
```{r echo=FALSE, out.width='100%'}
co2_nw_plot
```

##### Option 2 - 2nd indicator: Departures
```{r echo=FALSE, out.width='100%'}
co2_nw_plot2
```

##### Option 3 - 1st indicator: CO2 idx 2nd indicator: Departure idx
```{r echo=FALSE, out.width='100%'}
co2_nw_plot3
```
...
<ul class="nav nav-pills mb-1" role="tablist">
  <li class="nav-item m-1 active">
    <a class="nav-link" data-toggle="tab" aria-selected="true">`r last_month`</a>
  </li>
  <li class="nav-item m-1">
    <a class="nav-link" data-toggle="tab" aria-selected="false">Year to date (empty)</a>
  </li>
  <li class="nav-item m-1">
    <a class="nav-link" data-toggle="tab" aria-selected="false">Map (empty)</a>
  </li>
</ul>
