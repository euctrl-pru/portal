...
if (check_flights < 1000) {
  ...
  co2_data_plot_nw <- co2_data_plot_nw %>% filter (FLIGHT_MONTH < max(FLIGHT_MONTH))
}
...
co2_nw_plot3 <- co2_data_plot_nw_ld %>%
  ...
  layout(
    shapes = list(vline(as.Date('2023-01-01')) ,vline(as.Date('2022-01-01')), vline(as.Date('2021-01-01')),vline(as.Date('2020-01-01'))),
...
co2_data_plot_state <- co2_data_raw %>%
  ...
  mutate(MOM_GROWTH_CO2 = if_else(YEAR == last_year, CO2_QTY_TONNES/lag(CO2_QTY_TONNES, 12*(last_year-2019))-1,NA),
         MOM_GROWTH_TF = if_else(YEAR == last_year, TF/lag(TF, 12*(last_year-2019))-1,NA))%>%
...
<div class="col-4" >
<p style=" font-size:15px; margin-top:15px">vs 2022</p>
</div>
<div class="col-3" >
...
<div class="col-lg-9 pl-0 mt-1" id="observablehq-co2map-10fff34e">
</div><!-- closes col -->
...
<div class="col-lg-9 pl-0 mt-1" id="observablehq-co2map-65af85bf">
</div><!-- closes col -->
