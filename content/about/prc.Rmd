...
<div class="card">
  <img class="card-img-top" src="/images/prc/prc_AB.jpg" alt="Atholl BUCHAN">
  <div class="card-body"><h5 class="card-title">Atholl BUCHAN</h5><p class="card-text" style="color:grey">Focus: Airlines</p>
  </div></div>
<div class="card">
  <img class="card-img-top" src="/images/prc/prc_JMC.jpg" alt="José-Manuel CORDERO-GARCIA">
  <div class="card-body"><h5 class="card-title">José-Manuel CORDERO-GARCIA</h5><p class="card-text" style="color:grey">Focus: ANSP/Management</p>
  </div></div>
<div class="card">
  <img class="card-img-top" src="/images/prc/prc_MDJ.jpg" alt="Marinus DE JONG">
  <div class="card-body"><h5 class="card-title">Marinus DE JONG</h5><p class="card-text">PRC Chairman</p><p class="card-text" style="color:grey">Focus: Safety</p>
  </div></div>
<div class="card">
  <img class="card-img-top" src="/images/prc/prc_LH.jpg" alt="Lubos HLINOVSKY">
  <div class="card-body"><h5 class="card-title">Lubos HLINOVSKY</h5><p class="card-text" style="color:grey">Focus: Economics</p>
  </div></div> 
<div class="card">
  <img class="card-img-top" src="/images/prc/prc_IP.jpg" alt="Ismail Hakki POLAT ">
  <div class="card-body"><h5 class="card-title">Ismail Hakki POLAT</h5><p class="card-text" style="color:grey">Focus: Airports</p>
</div></div>
...
<div class="card">
  ...
  <div class="card-body"><h5 class="card-title">Daniel WEDER </h5><p class="card-text" style="color:grey">Focus: ATC/OPS</p>
  </div></div>
<div class="card">
  <img class="card-img-top" src="/images/prc/prc_PW.jpg" alt="Peter WHYSALL ">
  <div class="card-body"><h5 class="card-title">Dr Peter WHYSALL </h5><p class="card-text">PRC Vice Chairman</p><p class="card-text" style="color:grey">Focus: Environment</p>
  </div></div> 
<div class="card">
