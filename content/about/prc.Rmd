...
<div class="card-deck">
<div class="card">
  <img class="card-img-top" src="/images/prc/Simone_Schuldis_www.neonair.de_©_skyguide_ZH_airport-2263.png" alt="Daniel WEDER ">
  <div class="card-body"><h5 class="card-title">Daniel WEDER </h5><p class="card-text"></p>
  </div></div>
<div class="card">
  <img class="card-img-top" src="" alt="Peter WHYSALL ">
