...
<div class="carousel-item active"><div class="card bg-light border-0"><a href="https://www.eurocontrol.int/news/eurocontrols-prc-publishes-performance-insight-7-reorganising-ats-virtual-centres" target="_blank"><img class="card-img-top" src="/images/landing/pi7.png" alt=""><div class="card-body"><h5 class="card-title">PRC Performance Insight #7</h5></a><small><p class="card-text">Learn how the PRC supports the transformation process in ANS taking the example of Virtual Centres.</p></small></div></div></div>
...
<div class="carousel-item"><div class="card bg-light border-0"><a href="/publications/prc/news/2023_01_18_prc_news/"><img class="card-img-top" src="/images/landing/prc_tn.png" alt=""><div class="card-body"><h5 class="card-title">PRC Technical Note</h5></a><small><p class="card-text">
Check out the results of the PRC trial with ANSPs to improve transparency in ATFCM operations.</p></small></div></div></div>

<div class="carousel-item"><div class="card bg-light border-0"><a href="/publications/prc/transformation/"><img class="card-img-top" src="/images/landing/prc_tss.png" alt=""><div class="card-body"><h5 class="card-title">Transformation</h5></a><small><p class="card-text">
...
-->
<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><small><p class="card-text">December 2022 data <br> available for download now</p></small></div></div></div>
