...
<a href="https://www.eurocontrol.int/Economics/DailyTrafficVariation-States.html" class="btn btn-primary" role="button"><small>Access daily traffic dashboard</small></a>
</div>
</div>
</div>
...
<div class="carousel-item"><div class="card bg-light border-0"><a href="https://www.eurocontrol.int/publication/eurocontrol-comprehensive-aviation-assessment" target="_blank" ><img class="card-img-top" src="/images/landing/eca.png" alt=""><div class="card-body"><h5 class="card-title">Comprehensive assessments</h5></a><small><p class="card-text">
Read our EUROCONTROL aviation briefings on the latest trends in the European network.</p></small></div></div></div>
-->

<div class="carousel-item active"><div class="card bg-light border-0"><a href="https://www.eurocontrol.int/news/eurocontrols-prc-publishes-performance-insight-6-20-years-performance-oriented-approach-atm" target="_blank"><img class="card-img-top" src="/images/landing/pi6.png" alt=""><div class="card-body"><h5 class="card-title">Performance Insight</h5></a><small><p class="card-text">20 years of performance-oriented approach - A success story?</p></small></div></div></div>

<div class="carousel-item"><div class="card bg-light border-0"><a href="/library/prc_transformation_support_strategy_flyer.pdf"><img class="card-img-top" src="/images/landing/prc_tss.png" alt=""><div class="card-body"><h5 class="card-title">Transformation</h5></a><small><p class="card-text">
Learn about the PRC's strategy to support the transformation process in ANS.</p></small></div></div></div>

<div class="carousel-item"><div class="card bg-light border-0"><a href="/economics/ace-overview/"><img class="card-img-top" src="/images/landing/ace_hlsr2021.png" alt=""><div class="card-body"><h5 class="card-title">Preliminary high-level ACE report</h5></a><small><p class="card-text">
Read the first insights on 2021 cost-effectiveness performance, based on preliminary 2021 data.</p></small></div></div></div>

<div class="carousel-item"><div class="card bg-light border-0"><a href="/economics/cba/"><img class="card-img-top" src="/images/landing/cba.png" alt=""><div class="card-body"><h5 class="card-title">Inputs for Economic Analysis</h5></a><small><p class="card-text">
Check out EUROCONTROL's updated Standard Inputs for Economic Analyses - now available online!</p></small></div></div></div>
...
-->
<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><small><p class="card-text">November 2022 data <br> available for download now</p></small></div></div></div>
