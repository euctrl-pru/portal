...
<div class="carousel-item active"><div class="card  border-0"><a href="/traffic/punctuality/"><img class="card-img-top" src="/images/landing/ectl_pct.png" alt=""><div class="card-body"><h5 class="card-title">New: Punctuality performance</h5></a><small><p class="card-text">Check out the latest punctuality situation in Europe, including a breakdown by airport and state!</p></small></div></div></div>

<div class="carousel-item"><div class="card  border-0"><img class="card-img-top" src="/images/landing/ectl_asu.png" alt=""><div class="card-body"><h5 class="card-title">Coming soon: CO<sub>2</sub> Emissions</h5><small><p class="card-text">.... powered by the EUROCONTROL Aviation Sustainability Unit</p></small></div></div></div>

<div class="carousel-item"><div class="card  border-0"><a href="https://www.eurocontrol.int/publication/eurocontrol-data-snapshot-31-power-regional-market-segment" target="_blank"><img class="card-img-top" src="/images/landing/ectl_ds31.png" alt=""><div class="card-body"><h5 class="card-title">Data snapshot #31</h5></a><small><p class="card-text">
Learn about the new regional market segment recently introduced</p></small></div></div></div>
...
<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><p class="card-text">June 2022 data available now</p></div></div></div>
