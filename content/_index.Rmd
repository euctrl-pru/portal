...
<div class="carousel-item active"><div class="card  border-0"><a href="/data/#img-srcimagesprcq-operations-airportpng-width50-height50-altoperations-at-airports-operations-at-airports"><img class="card-img-top" src="/images/landing/env_cdo.jpg" alt=""><div class="card-body"><h5 class="card-title">New: Emissions from level flight</h5></a><small><p class="card-text">Analyse the additional CO<sub>2</sub> emissions from level flight segments at airports - available for download now!</p></small></div></div></div>
...
<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><p class="card-text">August 2022 data available now</p></div></div></div>
