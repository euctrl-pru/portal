...
<div class="carousel-item"><div class="card  border-0"><a href="/efficiency/emissions/"><img class="card-img-top" src="/images/landing/ectl_asu.png" alt=""><div class="card-body"><h5 class="card-title">New: Emissions dashboard</h5></a><small><p class="card-text">See the new CO<sub>2</sub> Emissions dashboard powered by the EUROCONTROL Aviation Sustainability Unit</p></small></div></div></div>
...
<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><p class="card-text">July 2022 data available now</p></div></div></div>
