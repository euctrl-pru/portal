---
title: PRC Position Paper on the future challenges to Safety
type: "PRC Position Paper"
date: '2020-12-18'
tags:
  - News
  - Funding
...
<div class="col-sm-3">
<div class="card border-0"><a href="/library/pp_prc_2020_12_Challenges_to_Safety.pdf">
  <img class="card-img-top" src="/images/prc/prc_pos1.jpg" alt="PRC Position Paper - Future challenges to safety">
  <div class="card-body"><h5 class="card-title">PRC Position Paper on the Future Challenges to Safety</h5></a><p class="card-text"></p>
</div></div>
</div>
...
Building on this initial exchange, the PRC held a [Workshop on 29 June 2020](/publications/prc/news/2020_06_29_prc_ws_saf/) that deepened the discussion. The Workshop was a starting point in defining safety performance objectives/focus areas for the future ATM system. The Workshop itself served as a platform to collect intelligence about “what do we know” and “what is available”.
...
<a href="/library/pp_prc_2020_12_Challenges_to_Safety.pdf" class="btn btn-secondary" role="button" target="_blank"> Download the full PRC position paper on the future challanges to safety <br> {{% dwnld_i %}} Download </a>
