...
## <img src="/images/prcq-env.png" width="40" height="40" alt="Environment"> Environment

Environment is an important political, economic and societal issue and the entire aviation industry has a responsibility 
...
En-route flight efficiency has a horizontal (distance) and vertical (altitude) component, both with a high relevance for fuel efficiency and the environment. 
