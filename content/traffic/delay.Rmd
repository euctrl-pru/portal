...
<div class="col-md-6">
#### ACC view
Total ATFM delay per ACC.
</div><!-- closes col -->

<div class="col-md-6">
#### Airport view
Total ATFM delay for main European airports.
</div><!-- closes col -->
</div><!-- closes row -->

<div class="row align-items-start">
<div class="col-md-6 p-0" style="min-width: 300px;">
...
<div class="col-md-6 p-0" style="min-width: 300px;">
<div id="apt-delay" style="margin-top: 0px;">
<iframe id="apt-delay-table" class="resp-iframe" src="https://www.eurocontrol.int/Economics/Oscar/plot-apt-delay-ranking-table.html" frameborder="0" style="border:0;" >
</iframe>
</div><!-- closes iframe container -->
</div><!-- closes col -->
</div><!-- closes row -->
