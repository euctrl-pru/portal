...
<a href="#" class="btn btn-info" role="button" target="_blank">{{% dwnld_i %}} Download network punctuality data</a>
...
<div class="col-md-6" >
#### Airport view
Punctuality for main EUROCONTROL airports.
<div class="row align-items-start">
<div class="col-12">
<div id="apt-pun">
...
<br>
<a href="#" class="btn btn-info" role="button" target="_blank">{{% dwnld_i %}} Download State/airport punctuality data</a>
<!-- </div><!-- closes tab pane-> -->
