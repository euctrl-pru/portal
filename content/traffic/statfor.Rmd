...
<div class="card"><a href="https://www.eurocontrol.int/forecasting" target="_blank">
  ...
  <div class="card-body"><h4 class="card-title">Get to know STATFOR!</h4><p class="card-text">Click here to learn more about STATFOR!</p></a>
  </div>
</div>
<div class="card"><a href="https://www.eurocontrol.int/forecasting#deliverables" target="_blank">
  ...
  <div class="card-body"><h4 class="card-title">STATFOR reports!</h4><p class="card-text">Click to view the latest STATFOR reports</p></a>
  </div>
</div>
<div class="card"><a href="https://www.eurocontrol.int/dashboard/statfor-interactive-dashboard" target="_blank">
  ...
  <div class="card-body"><h4 class="card-title">Show me the data!</h4><p class="card-text">Click to explore the STATFOR interactive dashboard</p></a>
  </div>
</div>
<div class="card"><a href="https://www.eurocontrol.int/ServiceUnits/Dashboard/EnRouteForecasts.html" target="_blank">
