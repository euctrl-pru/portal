...
(ref:hfe-year) Horizontal en-route flight efficiency - (`r state`). 
...
source(here::here("R/environment/state-read-hfe.R"))
source(here::here("R/environment/plot-hfe-year.R"))

hfe_year(year_input_start, year_input, state)
```