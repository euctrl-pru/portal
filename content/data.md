...
| Airport arrival ATFM delays<br><em> [with post ops adjustments][PostOps]</em><br><small> Monthly IFR arrivals and airport arrival [ATFM delay][ATFMdelay] by airport and delay category</small> | {{< getdata "dwnld" "apt_dly_post_beg" >}} - {{< getdata "dwnld" "apt_dly_post_end" >}} | [{{< dwnld_i >}}][APT-DLY-postxlsx] |                                | [{{< info_i >}}][APT-DLYmeta] | [KPI 12][ganp12]                   |
...
| <span style="color:red">NEW:</span> Vertical flight efficiency - Continuous climb and descent operations<br><small> Monthly continuous climb and descent data <span style="color:red">now including CO<sub>2</sub> emissions</span></small>                                                             | {{< getdata "dwnld" "cdo_beg" >}} - {{< getdata "dwnld" "cdo_end" >}}            | [{{< dwnld_i >}}][CDOxlsx]          |                                | [{{< info_i >}}][CDOmeta]  | [KPI 17][ganp17], [KPI 19][ganp19] |
