...
| Arrival Sequencing and Metering (ASMA) additional time<br><span style="color:#C0504D;"><small>Aug/Sep data not yet available due to processing issues</span></small><br><small> Monthly ASMA [additional][ASMAadditional] and [unimpeded][ASMAunimpeded] time</small>                                       | {{< getdata "dwnld" "asma_beg" >}} - {{< getdata "dwnld" "asma_end" >}}                 | [{{< dwnld_i >}}][ASMAxlsx]         |                                | [{{< info_i >}}][ASMAmeta]    | [KPI 08][ganp08]                   |
...
| Taxi-out additional time<br><span style="color:#C0504D;"><small>Sept data not yet available due to processing issues</span></small><br><small> Monthly taxi out [additional][TX-OUTadditional] and [unimpeded][TX-OUTunimpeded] time</small>                                                             | {{< getdata "dwnld" "tx_out_beg" >}} - {{< getdata "dwnld" "tx_out_end" >}}             | [{{< dwnld_i >}}][TX-OUTxlsx]       |                                | [{{< info_i >}}][TX-OUTmeta]  | [KPI 02][ganp02]                   |
| ATC pre-departure delays<br><span style="color:#C0504D;"><small>Aug/Sep data not yet available due to processing issues</span></small><br><small> Daily [ATC pre-departure delay][ATCpredepdelay] by airport</small>                                                                                        | {{< getdata "dwnld" "atc_pre_beg" >}} - {{< getdata "dwnld" "atc_pre_end" >}}           | [{{< dwnld_i >}}][ATC-PRExlsx]      |                                | [{{< info_i >}}][ATC-PREmeta] |                                    |
