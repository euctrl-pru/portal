...
Play with the filters or settings in the [following map][flows-map]
(or look at the sections for some examples and relevant links):
...
Answer: Britons and Germans seems to have *all* [flown to Spain][spain-aug]{target="_blank"}
...
Look at the very thin flow from USA...
