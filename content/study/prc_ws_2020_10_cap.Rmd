...
<div class="container">
<div class="row">
<a href="/library/prc_ws_2020_10_capacity_prc_summary_v1_0.pdf" class="btn btn-info mr-1" role="button" target="_blank"> PRC Summary Notes <br> {{% dwnld_i %}} Download </a>  
<a href="/library/prc_technical-note_Enroute Capacity.pdf" class="btn btn-info" role="button" target="_blank"> PRC TECHNICAL NOTE ON EN ROUTE CAPACITY <br> {{% dwnld_i %}} Download </a>
