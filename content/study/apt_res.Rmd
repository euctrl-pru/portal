...
```
<small><p style="color:#808080">Published: 30 July 2020</p></small>
<div class="container">
...
| Document download                      |
|--------------------------------|
| [{{% dwnld_i %}}][apt_cap_res] Airport Capacity Imbalance Study (for stakeholder comments) | 
</div>

#### Stakeholder feedback
<div class="container">
We invite all interested parties to submit their feedback <ins>**no later than 11 September 2020** </ins>by email to: [Performance Review Unit](mailto:PRU-Support@eurocontrol.int)
...
[apt_cap_res]: /library/TN_Airport_Capacity_Resilience_consultation_v1.pdf "Airport Capacity Imbalance Study"