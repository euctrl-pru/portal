...
This publication aims to accompany this new PRC work and the development of a new safety performance framework. It provides some background information on the work with dedicated safety experts in the EUROCONTROL Member States, and other international organisations, at the [PRC’s “Future challenges to Safety” workshop held on 29 June 2020](/study/prc_ws_2020_06_saf/). 
</div>
<div class="col-sm-3">
<div class="card border-0"><br>
  <img class="card-img-top" src="/images/pi_1-2020_cover.jpg" alt="PRC - Performance Insight - 1/2020">
</div>
</div>
</div></div>
...
<a href="/library/PRC-PI-1-2020-Future_challenges_of_safety.pdf" class="btn btn-info" role="button"> Performance Insight #1/2020 <br> Future Challenges to Safety <br> {{% dwnld_i %}} Download </a>
</div></div></div>
</div></div>
